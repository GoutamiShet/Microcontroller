;Write an ARM assembly program to demonstrate the usage of the MRS and  MSR instruction.AREA Demo, CODE, READONLY  
; Define a code section named "Demo" as read-only  
